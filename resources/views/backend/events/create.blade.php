          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <select class="form-control select2" style="width: 100%;" class="select2" name="user_id">
                  <option selected="selected" >Choose Coordinator</option>
                 @foreach($users as $user)
                  ...
                  <div class="form-group">
                <label>Team Running The Event</label>
                <select class="form-control select2" style="width: 100%;" class="select2" name="team_id">
