                ...
                <tr>
                  <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                    ...
                    <p style="{{ $style['paragraph'] }}">
                        You have been invited to join team <strong>{{$team->name}}</strong>.<br>
                      Please make sure you are logged in before accepting the invitation as only authorized members are allowed to join a team
                    </p>
